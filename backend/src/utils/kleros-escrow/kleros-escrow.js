...
import { erc20, escrow, tokenEscrow } from './utils/kleros-escrow/abis'
import { ethereumAddressRegExp } from './utils/kleros-escrow/parsing'
import { createWeb3, createWeb3FromModal } from './utils/kleros-escrow/web3-provider'
...
export default class KlerosEscrow {
  ...
  async createTransaction(amount, recipient, timeout, metaEvidence) {
    ...
    const createTransactionDefinition = this.contract.methods.createTransaction(
      ...(this.tokenContract
        ? [
            amount,
